...
// Main
(() => {
    const $$tagsDivs = document.querySelectorAll("aside#sidebar > section#tag-list > div.tag-list ul");
    for (const $tagDiv of $$tagsDivs) {
        ...
        $copyButton.addEventListener("click", () => navigator.clipboard.writeText(tagsText));
